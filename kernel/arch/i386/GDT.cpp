...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/08/28 02:02:44 by maroy             #+#    #+#             */
/*   Updated: 2024/08/28 02:02:50 by maroy            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void flush_gdt() { asm volatile("lgdt %0" ::"m"(s_gdtr)); }

extern "C" void flush_tss(uint16_t offset) { asm volatile("ltr %0" ::"m"(offset)); }
