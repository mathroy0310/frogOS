...
template <typename T> class LinkedList {
	FROG_NON_COPYABLE(LinkedList<T>);
	FROG_NON_MOVABLE(LinkedList<T>);
...
template <typename T> class LinkedListIterator {
  ...
  public:
	...
	LinkedListIterator(const LinkedListIterator<T> &other)
	    : m_current(other.m_current), m_past_end(other.m_past_end) {}
	...
	bool operator==(const LinkedListIterator<T> &other) const {
		return m_current && m_current == other.m_current && m_past_end == other.m_past_end;
	}
	bool operator!=(const LinkedListIterator<T> &other) const {
		return !(*this == other);
	}
  ...
  private:
	LinkedListIterator(typename LinkedList<T>::Node *node, bool past_end)
	    : m_current(node), m_past_end(past_end) {}
...
template <typename T> class LinkedListConstIterator {
  ...
  public:
	...
	LinkedListConstIterator(const LinkedListIterator<T> &other)
	    : m_current(other.m_current), m_past_end(other.m_past_end) {}
	LinkedListConstIterator(const LinkedListConstIterator<T> &other)
	    : m_current(other.m_current), m_past_end(other.m_past_end) {}
  ...
  private:
	LinkedListConstIterator(typename LinkedList<T>::Node *node, bool past_end)
	    : m_current(node), m_past_end(past_end) {}
